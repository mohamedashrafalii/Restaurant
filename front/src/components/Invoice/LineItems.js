        ...
        <div className={styles.lineItems}>
          <div className={`${styles.gridTable}`}>
            ...
            <div className={`${styles.row} ${styles.header}`}>
              ...
              <div style={{width:"100px"}}>المجوع</div>
              <div style={{width:"100px"}}>السعر</div>
              <div style={{width:"100px"}}>الكمية</div>
              <div style={{width:"200px"}}>المنتج</div>
                      ...
                      <Draggable key={item.id} draggableId={item.id} index={i}>
                        {(provided, snapshot) => (
                          ...
                          >
                            <LineItem
                              style={{color: 'red'}}
                              key={i + item.id} index={i} nameAr={item.nameAr}
                              mainService={item.mainService} quantity={item.quantity} price={item.price}
                              {...functions}
                            />
                          </div>
                        )}
